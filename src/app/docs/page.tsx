      ...
      <div className="mt-12 grid gap-12 md:grid-cols-[210px_minmax(0,1fr)] md:gap-14">
        ...
        <div className="flex min-w-0 flex-col gap-10">
          ...
          <Section id="token-rewards" title="Token and rewards">
            <P>Advertising revenue and token rewards are separate streams. AIRTIME collects advertising payments in SOL. StonkFun handles holder distributions for tokens launched in Reward Mode, using the paired token selected at launch.</P>
            <P>Once AIRTIME&apos;s contract address is published, the treasury page follows that exact mint through StonkFun&apos;s public API. Market price, market cap, trading volume, reward totals and reported burns refresh automatically. Until then, it displays CA coming soon.</P>
            <h3 className="text-lg font-medium text-ink-50">Where each stream goes</h3>
            <div className="overflow-x-auto"><table className="w-full text-left text-sm"><thead><tr className="border-b border-white/15"><th className="p-3">Stream</th><th className="p-3">Source</th><th className="p-3">Destination</th></tr></thead><tbody className="text-ink-300"><tr className="border-b border-white/10"><td className="p-3">Advertising revenue</td><td className="p-3">Station surfaces sold in SOL</td><td className="p-3">Designated for AIRTIME buybacks and burns, with completed activity recorded by the station</td></tr><tr><td className="p-3">Reward Mode fees</td><td className="p-3">Token fees collected through StonkFun&apos;s reward mechanism</td><td className="p-3">Paired reward tokens distributed to eligible holders by StonkFun</td></tr></tbody></table></div>
            <h3 className="text-lg font-medium text-ink-50">StonkFun holder rewards</h3>
            <P>The site reads AIRTIME&apos;s actual launch mode and paired asset. StonkFun&apos;s current Reward Mode uses a transfer tax to fund automatic holder payouts in the quote token. Standard Mode does not pay these holder rewards. The published mode and asset determine what is shown; the site does not assume Anduril exposure or label token balances as directly owned company shares.</P>
            <P>Eligibility, thresholds and payout timing follow StonkFun&apos;s rules and available reward funds. AIRTIME does not run a separate daily snapshot, impose a one-token minimum, or promise a fixed daily payout. The treasury page shows total rewards distributed, rewards awaiting distribution, holders paid and the last reported payout time.</P>
            <P><a className="text-signal" href="https://www.stonkfun.xyz/rewards" target="_blank" rel="noreferrer">StonkFun rewards</a> and the <a className="text-signal" href="https://www.stonkfun.xyz/developers" target="_blank" rel="noreferrer">official API documentation</a> describe the platform&apos;s current mechanism.</P>
            <h3 className="text-lg font-medium text-ink-50">Buybacks and burns</h3>
            <P>StonkFun-reported burns and current flywheel participation are displayed for AIRTIME&apos;s mint, with Solscan transaction links. Participation follows the platform&apos;s current criteria and can change. These figures describe platform activity, not automatic spending from AIRTIME&apos;s advertising treasury.</P>
            <P>Advertising revenue remains designated for separate AIRTIME buybacks and burns. A completed station buyback or burn needs its own transaction reference. Reporting StonkFun data does not move funds or execute a trade.</P>
            <P>When the upstream feed is unavailable, the site labels any retained figures as stale. Missing data is not presented as zero rewards. <Link href="/treasury" className="text-signal">View token metrics and rewards →</Link></P>
          </Section>
